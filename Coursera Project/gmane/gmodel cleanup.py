...
conn_1 = sqlite3.connect('mapping.sqlite3')
...
conn_2 = sqlite3.connect('gmane_content.sqlite3')
...
cur_2.execute('''SELECT headers, body, sent_at FROM Messages ORDER BY sent_at''')
...
for message_row in www :
    ...
    print (sender_id, subject_id, guid_id)
    ...
    cur.execute('INSERT OR IGNORE INTO Messages (guid,sender_id,subject_id,sent_at,headers,body) VALUES ( ?,?,?,?,?,? )', (guid, sender_id, subject_id, sent_at, message_row[0], message_row[1]))
    conn.commit()
